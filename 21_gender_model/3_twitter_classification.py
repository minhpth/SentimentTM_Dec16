...
#------------------------------------------------------------------------------
# APPLYING GENDER CLASSIFYING MODEL - APLLYING MODEL
#------------------------------------------------------------------------------
...
def apply_model(dataIn, categorical_cols, numerical_cols, user_col):
    ...
    file_in = '.\\model\\output\\gender_classifier_model.pkl'
    ...
    # Target values: F = 0, M = 1
    target_pred_xgb_label = labelEncoder.inverse_transform(target_pred_xgb)

    dataOut['pred_gender'] = target_pred_xgb_label
    dataOut['pred_gender_confidence'] = target_pred_xgb_proba.max(axis=1)
    #dataOut['pred_F_proba'] = target_pred_xgb_proba[:,0]
    #dataOut['pred_M_proba'] = target_pred_xgb_proba[:,1]
...
if __name__ == '__main__':
    ...
    fileNameIn = '.\\Output\\allUsers_fullFeaturesGenderOUT_30k.tsv'
    fileNameOut = '.\\Output\\allUsers_fullFeaturesGenderOUT_30k_classified.tsv'
