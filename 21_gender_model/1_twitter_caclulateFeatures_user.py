...
#------------------------------------------------------------------------------
# APPLYING GENDER CLASSIFYING MODEL - EXTRACT FEATURES
#------------------------------------------------------------------------------
...
ageLex_file = '.\\model\\lexicons\\emnlp14gender.csv'
...
def parseTwitterFile(fileNameIn, maxTweet=-1):
    ...
    userName = extractUserID_fromFileName(fileNameIn)
...
if __name__ == '__main__':
    ...
    fileNameOut = '.\\output\\allUsers_tweets_featuresGender_30k.tsv' # Output file
