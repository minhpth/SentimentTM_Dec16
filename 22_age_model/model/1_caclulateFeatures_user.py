...
#------------------------------------------------------------------------------
# AGE CLASSIFYING MODEL - BUILD MODEL - EXTRACTING FEATURES
#------------------------------------------------------------------------------
...
# Read lexiconns data
ageLex_file = '.\\lexicons\\emnlp14age.csv'
...
if __name__ == '__main__':
    ...
    inputDir = '.\\input\\user_tweetsAge\\'
    fileNameOut = '.\\output\\allUsers_tweets_features.tsv'
