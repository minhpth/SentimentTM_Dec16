...
file_in = '.\\output\\17_user_profile_type_with_image_features.tsv'
userDataWithF = pd.read_csv(file_in, sep='\t', encoding='utf-8')
userDataWithF.description.fillna('', inplace=True)
userDataWithF.status_text.fillna('', inplace=True)
userDataWithF.location.fillna('', inplace=True)
userDataWithF['text_combined'] = userDataWithF.description + ' ' + \
                                 userDataWithF.status_text + ' ' + \
                                 userDataWithF.location
...
# Save to file
file_out = '.\\output\\17_user_profile_type_full_features.tsv'
