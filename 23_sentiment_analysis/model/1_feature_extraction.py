...
#------------------------------------------------------------------------------
# SENTIMENT CLASSIFIER - BUILD MODEL - FEATURES EXTRACTION
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Import different text lexicons
#------------------------------------------------------------------------------
...
# Import lexicon
cluster_file = '.\\lexicons\\cmu_nlp_clustering\\50mpaths2.txt'
...
# Import lexicon
hashtag_sentiment_unigramFile = '.\\lexicons\\HashtagSentimentAffLexNegLex\\HS-AFFLEX-NEGLEX-unigrams.txt'
...
# Import lexicon
S140_LexiconsFile = '.\\lexicons\\Sentiment140AffLexNegLex\\S140-AFFLEX-NEGLEX-unigrams.txt'
...
# Inport lexicon
mpqa_lexiconFile = '.\\lexicons\\subjectivity_clues_hltemnlp05\\subjclueslen1-HLTEMNLP05.tff'
...
nrcEmotion_LexiconFile = '.\\lexicons\\NRC-Emotion-Lexicon-v0.92\\NRC-emotion-lexicon-wordlevel-alphabetized-v0.92.txt'
...
ling_lexiconNegFile = '.\\lexicons\\ling_lexicon\\negative-words.txt'
ling_lexiconPosFile = '.\\lexicons\\ling_lexicon\\positive-words.txt'
...
if __name__ == '__main__':
    ...
    fileNameIn = '.\\input\\data_challenge2013\\tweeti-b.distFULL.tsv'
    fileNameOut = '.\\output\\data_challenge2013\\tweeti-b.distFULL_featureEncoded.tsv'

    dataIn = pd.read_csv(fileNameIn, sep='\t', error_bad_lines=False,
                         dtype={'id1':np.str, 'id2':np.str, 'polarity':np.str, 'text': np.str},
                         encoding='utf-8')
    ...
    includeGT = True # Work with real twets if False
    ...
    #--------------------------------------------------------------------------
    # Extract text features from testing dataset
    #--------------------------------------------------------------------------

    fileNameIn = '.\\input\\data_challenge2013\\tweeti-b.dev.distFULL.tsv'
    fileNameOut = '.\\output\\data_challenge2013\\tweeti-b.dev.distFULL_featureEncoded.tsv'
